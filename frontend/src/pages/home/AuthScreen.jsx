...
export default function AuthScreen() {
	...
	<div className='hero-bg relative'>
		...
		<header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
			...
			<Link to={"/login"} className='text-sm font-semibold text-white bg-red-600 py-1.5 px-3.5 rounded'>
				Sign In
			</Link>
		</header>
		...
		<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
				...
				<form className="flex flex-col sm:flex-row gap-4 w-11/12 md:w-1/2" onSubmit={handleSubmit}>
					<input 
						type="email"
					...
					/>
					<button className='bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-2 rounded flex justify-center items-center w-1/2 mx-auto sm:w-auto'>
						Get Started
